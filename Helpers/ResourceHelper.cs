...
namespace XelLauncher.Helpers
{
    public static class ResourceHelper
    {
        public static System.Drawing.Icon LoadIcon(string name)
        {
            ...
            using var stream = asm.GetManifestResourceStream($"XelLauncher.Icons.{name}");
        ...
        public static void ExtractAndOverwrite(string targetRoot, string zipResourceName)
        {
            ...
            try
            {
                using (Stream resourceStream = asm.GetManifestResourceStream($"XelLauncher.{zipResourceName}"))
                {
